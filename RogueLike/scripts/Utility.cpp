...
bool Utility::getQuadPrimitiveData(std::vector<glm::vec3>& _vertexBufferData, std::vector<glm::vec2>& _uvBufferData) {
	_vertexBufferData = std::vector<glm::vec3>();
	_vertexBufferData.insert(_vertexBufferData.end(), glm::vec3(0.0f, 0.0f, 0.0f));
	_vertexBufferData.insert(_vertexBufferData.end(), glm::vec3(10.0f, 1.0f, 0.0f));
	_vertexBufferData.insert(_vertexBufferData.end(), glm::vec3(0.0f, 10.0f, 0.0f));

	_vertexBufferData.insert(_vertexBufferData.end(), glm::vec3(10.0f, 0.0f, 0.0f));
	_vertexBufferData.insert(_vertexBufferData.end(), glm::vec3(0.0f, 0.0f, 0.0f));
	_vertexBufferData.insert(_vertexBufferData.end(), glm::vec3(10.0f, 0.0f, 0.0f));

	_uvBufferData = std::vector<glm::vec2>();
	_uvBufferData.insert(_uvBufferData.end(), glm::vec2(0.0f, 0.0f));
	_uvBufferData.insert(_uvBufferData.end(), glm::vec2(0.0f, 1.0f));
	_uvBufferData.insert(_uvBufferData.end(), glm::vec2(1.0f, 1.0f));

	_uvBufferData.insert(_uvBufferData.end(), glm::vec2(1.0f, 1.0f));
	_uvBufferData.insert(_uvBufferData.end(), glm::vec2(1.0f, 0.0f));
	_uvBufferData.insert(_uvBufferData.end(), glm::vec2(0.0f, 0.0f));
	return true;
}
