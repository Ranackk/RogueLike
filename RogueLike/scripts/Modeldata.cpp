...
void ModelData::initialize(const std::vector<unsigned short> _indexBufferData, const std::vector<glm::vec3> _vertexBufferData,
                           const std::vector<glm::vec2> _uvBufferData, const std::vector<glm::vec3> _normalsBufferData) {
	this->m_IndicesBufferData = _indexBufferData;
	this->m_VertexBufferData = _vertexBufferData;
	this->m_UvBufferData = _uvBufferData;
	this->m_NormalBufferData = _normalsBufferData;
